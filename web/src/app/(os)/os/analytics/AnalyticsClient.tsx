...
import { useAnalyticsSnapshot } from "@/hooks/useScoreMap";

type EngineId = "body" | "mind" | "money" | "charisma";

const ALL_ENGINES: EngineId[] = ["body", "mind", "money", "charisma"];

function listEngines(): EngineId[] {
  return ALL_ENGINES;
}
