...
export function SkillNode({
  ...
  // Phase QA: replaced @ts-ignore Wrapper swap with type-safe conditional
  const WrapperEl = status === "ready"
    ? (props: { children: React.ReactNode }) => (
        <Pressable onPress={handlePress} style={styles.nodeWrapper}>{props.children}</Pressable>
      )
    : (props: { children: React.ReactNode }) => (
        <View style={styles.nodeWrapper}>{props.children}</View>
      );
