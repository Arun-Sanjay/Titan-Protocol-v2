...
export default function SignupScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // If email confirmation is disabled (default), we get a session
      // right away and the root layout redirects to onboarding.
      // If it's enabled, we stay here and tell the user to check email.
      const {
        data: { session },
